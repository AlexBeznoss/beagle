class InstallMotorAdmin < ActiveRecord::Migration[7.0]
  def self.up
    ...
    create_table :motor_taggable_tags do |t| # rubocop:disable Rails/CreateTableWithTimestamps
    ...
    create_table :motor_audits do |t| # rubocop:disable Rails/CreateTableWithTimestamps
    ...
    create_table :motor_note_tag_tags do |t| # rubocop:disable Rails/CreateTableWithTimestamps
